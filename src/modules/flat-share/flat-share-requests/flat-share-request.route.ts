...
import { CreateHostRequestDTO, CreateSeekerRequestDTO, SearchRequestDTO, UpdateHostRequestDTO, UpdateSeekerRequestDTO } from "./flat-share-request.dto";
...
export default class FlatShareRequestRoute implements Routes {
  ...
  private initializeRoutes() {
    ...
    this.router.get(`${this.path}/search`, validationMiddleware(SearchRequestDTO, 'params'), this.flatShareRequestController.searchRequest);
